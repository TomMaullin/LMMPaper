...
#
# 1: Comment out the two python commands above.
...
# different commands for submitting to a cluster. If the above is not clear please do leave a comment on the github
